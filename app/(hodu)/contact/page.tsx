  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-20 space-y-16 animate-fade-in bg-white">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
        ...
        {/* Form */}
        <div className="lg:col-span-7 bg-white border-2 border-brand-border p-6 sm:p-9 rounded-3xl shadow-xs space-y-6">
          ...
          {err && (
            <div className="bg-red-50 text-brand-maroon border border-red-200 p-4 rounded-xl text-xs font-semibold">
              ⚠️ {err}
            </div>
          )}
            ...
            <form onSubmit={submit} className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1">
                  <label className="text-xs font-bold text-neutral-800 block">Parent / Student Name *</label>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1">
                  <label className="text-xs font-bold text-neutral-800 block">Email Address (Optional)</label>
